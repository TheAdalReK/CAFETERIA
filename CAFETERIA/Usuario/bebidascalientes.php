...
<body>
    ...
    <main>
        <?php
            $response = json_decode(file_get_contents('https://cafeteriamineral.000webhostapp.com/Usuario/api/productos/api-productos.php?categoria=bebidascalientes'), true);
