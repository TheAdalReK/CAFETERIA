...
<body>
    ...
    include_once '../database.php';
        ...
        foreach($resultado as $row){
            ...
            echo "<br>";
            // echo "<form action='realizarPedido.php?id=$id' method='get'>";
            //     echo "<button type='submit'>Realizar Pedido</button>";
            // echo "</form>";
            if($row['estado'] == 0){
                echo "<button type='submit' class='boton-realizar-pedido'>";
                    echo "<a href='realizarPedido.php?id=$id'>Realizar Pedido</a>";
                echo "</button>";
            }else if($row['estado'] == 1){
                echo "<button type='submit' class='boton-finalizar-pedido'>";
                    echo "<a href='entregarPedido.php?id=$id'>Entregar Pedido y Finalizar</a>";
                echo "</button>";
            }else
                ;
        }
