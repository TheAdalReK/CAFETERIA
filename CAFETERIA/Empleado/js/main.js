...
function actualizarCarritoUI(){
    fetch('https://cafeteriamineral.000webhostapp.com/Empleado/api/carrito/api-carrito.php?action=mostrar')
...
function eliminarItems() {
    fetch('https://cafeteriamineral.000webhostapp.com/Empleado/api/carrito/api-carrito.php?action=removeAll', {
        method: 'POST'
    })
    .then(response => response.json())
    .then(data => {
...
function removeItemFromCarrito(id){
    fetch('https://cafeteriamineral.000webhostapp.com/Empleado/api/carrito/api-carrito.php?action=remove&id=' + id)
    .then(res => res.json())
    .then(data =>{
...
function addItemToCarrito(id){
    fetch('https://cafeteriamineral.000webhostapp.com/Empleado/api/carrito/api-carrito.php?action=add&id=' + id)
    .then(res => res.json())
    .then(data =>{
        console.log(data.status);
        actualizarCarritoUI();
