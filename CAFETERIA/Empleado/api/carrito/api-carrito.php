...
include_once 'carrito.php';
    ...
    function mostrar($carrito){
        ...
        foreach($itemsCarrito as $itemCarrito){
            $httpRequest = file_get_contents('https://cafeteriamineral.000webhostapp.com/Empleado/api/productos/api-productos.php?get-item=' . $itemCarrito['id']);
    ...
    function removeAll($carrito){
    $res = $carrito->removeAll();
    if($res){
        echo json_encode(['statuscode' => 200]);
    }else{
        echo json_encode(['statuscode' => 400]);
