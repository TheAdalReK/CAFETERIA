...
<head>
    ...
    <title>Pedido: Bebidas Friast</title>
...
<body>
    ...
    <main>
        <?php
            $response = json_decode(file_get_contents('https://cafeteriamineral.000webhostapp.com/Empleado/api/productos/api-productos.php?categoria=bebidasfrias'), true);
