...
<body>
    ...
    ?>
    <main>
        <div id="mi_variable" style="display:none;"><?php echo $mi_variable; ?></div>
        <?php
            $response = json_decode(file_get_contents('https://cafeteriamineral.000webhostapp.com/Empleado/api/productos/api-productos.php?categoria=alimentos'), true);
